...
export default function Page() {
    return (
        ...
        >
            <CardText>
                <Markdown>{`
L'épreuve reine de la CapybaRun, le 200 Km est une course d'endurance extrême. Réputée pour être l'une des courses les plus difficiles du calendrier ultra-trail mondial, la CapybaRun 200 Km est un défi pour les coureurs les plus aguerris.
